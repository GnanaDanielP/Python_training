...
class BooksSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for block in blocks:
            ...
            yield scrapy.Request(url=detail_url, callback=self.parse_detail,dont_filter=True,cb_kwargs={"source_url":source_url,"book_name":book_name,'book_price':book_price})
    ...
    def parse_detail(self, response,source_url,book_name,book_price):
        ...
        for detail_page in detail_pages:
            ...
            item = {'source_url':source_url,'book_name':book_name,'book_price':book_price}
