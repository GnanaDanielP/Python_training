...
for detail in details:
  ...
  breakpoint() 
  with open (r"C:\Users\danie\python_script\trader\auto_trader.txt","a+",encoding="utf-8")as file:
    file.write(f'{link}\t{price}\t{engine}\t{mileage}\t{fuel}\t{color}\t{transmission}\t{drive_type}\t{bed_length}\n')
